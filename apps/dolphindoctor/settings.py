"""
Django settings for dolphindoctor project.
...
Dolphindoctor_LOG_FILE = os.path.join(LOG_DIR, 'dolphindoctor.log')
...
MIDDLEWARE = [
    ...
    'dolphindoctor.middleware.TimezoneMiddleware',
    'dolphindoctor.middleware.DemoMiddleware',
    'dolphindoctor.middleware.RequestMiddleware',
    'orgs.middleware.OrgMiddleware',
]


ROOT_URLCONF = 'dolphindoctor.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'dolphindoctor.context_processor.dolphindoctor_processor',
...
# WSGI_APPLICATION = 'dolphindoctor.wsgi.applications'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'backupCount': 7,
            'formatter': 'main',
            'filename': Dolphindoctor_LOG_FILE,
        },
        'ansible_logs': {
            'encoding': 'utf8',
            'level': 'DEBUG',
    ...
    'loggers': {
        ...
        'dolphindoctor.users.api': {
            'handlers': ['console', 'file'],
            'level': LOG_LEVEL,
        },
        'dolphindoctor.users.view': {
            'handlers': ['console', 'file'],
            'level': LOG_LEVEL,
        },
        'ops.ansible_api': {
...
# Email config
EMAIL_HOST = 'smtp.dolphindoctor.org'
EMAIL_PORT = 25
EMAIL_HOST_USER = 'noreply@dolphindoctor.org'
EMAIL_HOST_PASSWORD = ''
EMAIL_FROM = ''
EMAIL_USE_SSL = False
EMAIL_USE_TLS = False
EMAIL_SUBJECT_PREFIX = '[DPD] '
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        ...
        'common.renders.DPDCSVRender',
    ),
    'DEFAULT_PARSER_CLASSES': (
        'rest_framework.parsers.JSONParser',
        'rest_framework.parsers.FormParser',
        'rest_framework.parsers.MultiPartParser',
        'common.parsers.DPDCSVParser',
...
AUTH_LDAP_BIND_DN = 'cn=admin,dc=dolphindoctor,dc=org'
AUTH_LDAP_BIND_PASSWORD = ''
AUTH_LDAP_SEARCH_OU = 'ou=tech,dc=dolphindoctor,dc=org'
...
SWAGGER_SETTINGS = {
    'DEFAULT_AUTO_SCHEMA_CLASS': 'dolphindoctor.swagger.CustomSwaggerAutoSchema',
