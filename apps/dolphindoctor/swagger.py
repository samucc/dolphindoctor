...
def get_swagger_view(version='v1'):
    ...
    schema_view = get_schema_view(
        openapi.Info(
            title="Dolphindoctor API Docs",
            default_version=version,
            description="Dolphindoctor Restful api docs",
            terms_of_service="https://www.dolphindoctor.org",
            contact=openapi.Contact(email="support@alphacar.io"),
