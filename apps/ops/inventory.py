...
__all__ = [
    'DPDInventory', 'DPDCustomInventory',
]
...
class DPDBaseInventory(BaseInventory):
...
class DPDInventory(DPDBaseInventory):
    """
    DPD Inventory is the manager with dolphindoctor assets, so you can
...
class DPDCustomInventory(DPDBaseInventory):
    """
    DPD Custom Inventory is the manager with dolphindoctor assets,
