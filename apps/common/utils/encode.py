...
def ssh_pubkey_gen(private_key=None, username='dolphindoctor', hostname='localhost', password=None):
...
def ssh_key_gen(length=2048, type='rsa', password=None, username='dolphindoctor', hostname=None):
